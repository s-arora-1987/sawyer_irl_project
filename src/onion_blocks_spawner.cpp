...
int main(int argc, char **argv)
{
    ...
    ros::Publisher modelnames_publisher = nh.advertise<sawyer_irl_project::StringArray>("modelnames", 1);
    ...
    while (ros::ok())
    {
        ...
        while (i < total_onions)
        {
            ...
            // spawn_model_srv_msg.request.initial_pose.orientation.x = distribution(generator);
            // spawn_model_srv_msg.request.initial_pose.orientation.x = distribution(generator);
            // spawn_model_srv_msg.request.initial_pose.orientation.x = distribution(generator);
            // spawn_model_srv_msg.request.initial_pose.orientation.x = distribution(generator);
